...
def train(args):
    ...
    ESM = np.load('/home/sgzhang/perl5/GAT-GO/HIF2GO/data/'+args.species+'/ESM-embeddings.npy')#ESM-embeddings.npy
...
if __name__ == "__main__":
    ...
    parser.add_argument('--mask_rate', type=float, default=0.3, help="mask rate.")
